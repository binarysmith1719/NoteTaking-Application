...
class LoginFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        var loginbutton=view.findViewById<Button>(R.id.btn_login)
        var signupbutton = view.findViewById<Button>(R.id.btn_signup)
        var editTextEmail = view.findViewById<EditText>(R.id.edt_eml)
        var editTextPass = view.findViewById<EditText>(R.id.edt_pass)
        ...
        loginbutton.setOnClickListener(object: View.OnClickListener {
            override fun onClick(view: View?) {
                ...
                {
                    InterfaceReference.SignIn(email,pass)
//                    if(result==0)
//                    { Toast.makeText(activity,"Enter valid email and password", Toast.LENGTH_SHORT).show() }
        ...
        signupbutton.setOnClickListener{
            ...
            activity?.supportFragmentManager?.beginTransaction()?.replace(R.id.fragContainer,signUpFragment)?.commit()
        }
        return view
    }
